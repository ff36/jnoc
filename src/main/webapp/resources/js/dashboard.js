...
var resultsPath = document.getElementById('form:csv-file-path').value;
...
//```
d3.csv(resultsPath, function (data) {
    ...
    gainOrLossChart
        .width(220) // (optional) define chart width, :default = 200
    ...
    moveChart
        ...
        .elasticY(true)
        .renderHorizontalGridLines(true)
        .legend(dc.legend().x(610).y(10).itemHeight(13).gap(5))
        .brushOn(false)
        // Add the base layer of the stack with group. The second parameter specifies a series name for use in the legend
        // The `.valueAccessor` will be used for the base layer
        .group(indexAvgByMonthGroup, "Resolved")
        .valueAccessor(function (d) {
            return d.value.avg;
        })
        // stack additional layers with `.stack`. The first paramenter is a new group.
        // The second parameter is the series name. The third is a value accessor.
        .stack(monthlyMoveGroup, "Submitted", function (d) {
            return d.value;
        })
