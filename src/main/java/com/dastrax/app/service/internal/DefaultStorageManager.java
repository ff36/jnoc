...
//</editor-fold>
     ...
     * @param id The id of the user, company, attachment (s3id) etc.
    ...
    public CompleteMultipartUploadResult put(
        ...
        InitiateMultipartUploadRequest initRequest
                = new InitiateMultipartUploadRequest(s3Bucket, key)
                .withCannedACL(acl);
        InitiateMultipartUploadResult initResponse
                = s3.getClient().initiateMultipartUpload(initRequest);
        ...
        try {
            return s3.getClient().copyObject(
                    new CopyObjectRequest(
                            ...
                            s3Bucket,
                            destinationKey)
                    .withCannedAccessControlList(acl));
...
//</editor-fold>
        ...
        public S3() {
            ...
            try {
                ...
                System.err.println("Error creating AmazonS3Client: " + t);
            }
        }
//</editor-fold>
