...
import co.ff36.jnoc.per.project.JNOC.IncidentStatus;
...
//</editor-fold>
     ...
     */
    public void changeStatus(JNOC.IncidentStatus status) {
        ...
        switch (status) {
            ...
            case ARCHIVED:
                ...
                } else if (!this.status.equals(JNOC.IncidentStatus.CLOSED)) {
                    JsfUtil.addWarningMessage("Incident "
                            + id
    ...
    private boolean solved() {
        ...
        if (!this.status.equals(JNOC.IncidentStatus.CLOSED)) {
